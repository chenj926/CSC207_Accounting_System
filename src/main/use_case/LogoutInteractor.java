...
public class LogoutInterface implements LogoutInputBoundary{
    final LogoutDataAccessInterface userDataAccessObject;
    final LogoutOutputBoundary presenter;

    public LogoutDataAccessInteractor(LogoutDataAccessInterface userDataAccessObject, LogoutOutputBoundary presenter) {
